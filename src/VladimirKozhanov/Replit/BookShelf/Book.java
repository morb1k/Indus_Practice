...
public class Book {
    ...
    public static String capitalize(String word) {
        ...
        capitalize += (word.charAt(0) + "").toUpperCase() + word.substring(1);
        return capitalize;
    ...
    public static boolean isTitleWord(String word) {
        ...
        ArrayList<String> testCase = new ArrayList<>(Arrays.asList("a" , "an", "the","and", "but", "for", "nor", "or", "so", "yet", "at", "by", "in", "into", "near", "of", "on", "to", "than", "via"));
        if(testCase.contains(word)){
            return false;
        }
        return true;
    }
    ...
    public void setTitle(String title) {
       ...
       // ArrayList<String> bla = new ArrayList<>(Arrays.asList(title.split(" ")));

    }  //false if contains articles etc.
